...
private static SessionFactory sf;
	public static SessionFactory getSessionFacory()
	{
		...
		setting.put(Environment.URL, "jdbc:mysql://localhost:3306/crudhiber");
	  ...
	  setting.put(Environment.HBM2DDL_AUTO,"update");
		...
		MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(com.model.Employee.class);
