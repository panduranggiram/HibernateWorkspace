...
private static SessionFactory sf;
	public static SessionFactory getSessionFacory()
	{
		...
		setting.put(Environment.URL, "jdbc:mysql://localhost:3306/criteria_builder_select");
	  ...
	  //setting.put(Environment.HBM2DDL_AUTO,"update");
		...
		MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(Employee1.class).addAnnotatedClass(Department.class);
